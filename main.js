document.addEventListener('DOMContentLoaded', function() {
    ...
    console.log('Buscando tarjetas de stock...');
    const cards = document.querySelectorAll('.card-hover');
    console.log('Tarjetas encontradas:', cards.length);
    
    cards.forEach((card, index) => {
        const overlay = card.querySelector('.info-overlay');
        console.log(`Tarjeta ${index}: overlay encontrado:`, overlay !== null);
        
        if (overlay) {
            card.addEventListener('mouseenter', function() {
                console.log('Mouse enter en tarjeta', index);
                overlay.style.opacity = '1';
                overlay.style.transform = 'translateY(0)';
            });
            
            card.addEventListener('mouseleave', function() {
                console.log('Mouse leave en tarjeta', index);
            ...
            card.addEventListener('click', function() {
                ...
                console.log('Click en tarjeta', index, 'Visible:', isVisible);
